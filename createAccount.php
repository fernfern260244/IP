        ...
        <div class="bg-orange-200 rounded-r-lg " style="width: 500px; height: 600px;">
            ...
            <div class="ml-24">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="password_1">
                  ...
                  <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" style="width: 320px;"  id="password" type="password" placeholder="******************" required name="password_1"><br>
            </div>
            <!-- <div class="ml-24">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="password_2">
                    Confirm Password
                  </label>
                  <input class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" style="width: 320px;"  id="password" type="password" placeholder="******************" required name="password_2"><br>
            </div> -->
