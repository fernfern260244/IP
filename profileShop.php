...
<head>
    ...
    <title>หน้าโปรไฟล์ร้านค้า</title>
</head>
<body>
    ...
    <div class="flex justify-center bg-orange-300">
        <div class="flex items-center justify-center  h-64 w-64">
            <img class="rounded-full h-20 w-20" src="images/pro.png" alt="Circular Image">
        </div>
    </div>
    
    <div class="flex justify-center bg-orange-300">
        <div class="flex items-center justify-center  ">
            <text class="p-1 "> 123456 คนติดตาม</text>
        </div>
    </div>

<div>
    
<div class="flex items-center  border border-b-2 p-5 bg-amber-600 ">

    <h1 class="font-semibold text-2xl text-center p-5">ชื่อร้าน</h1>
    ...
    <select id="countries" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block  p-2.5 ">
      <option selected class="ml-auto">หมวดหมู่</option>
      <option value="Sword">ดาบสปาต้า</option>
    </select>
    <div class="grid grid-cols-2 gap-3 ml-auto">
        <img style="width: 30px;" src="images/chat.png" alt="แชท">
        <img style="width: 30px;" src="images/user.png" alt="ติดตาม" >
    </div>
</div>  
    


    <div class="bg-orange-200 border border-black h-auto w-auto">

        <div class="border border-black h-auto w-auto">
            
              
              
                <div class="container mx-auto mt-5">
                  <div class="grid grid-cols-3 gap-4 m-2">
                    <div class="bg-white p-4 border border-b-4">
                        <img class="w-20" src="images/Celine-Mini-Ava-in-Tromphe-Canvas-and-Calfskin-Tan-Shoulder-Bag.jpg" alt="Product 3">
                        <div class="grid grid-cols-2">
                        <h2 class="text-xl  font-bold mt-4">Buy</h2>
                        <h2 class="text-xl font-bold mt-4">Chat</h2> </div>
                      </div>
                    </div>
                  </div>
